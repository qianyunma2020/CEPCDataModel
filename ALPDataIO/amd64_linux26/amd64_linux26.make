...
includes= $(ppcmd)"$(ALPDataIO_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/data/BOSSParallel/CEPCDataModel/InstallArea/include" $(ppcmd)"/data/BOSSParallel/sniper/InstallArea/include" $(use_includes)
...
ALPDataIO_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(ALPDataIO_use_linkopts)
ALPDataIO_use_linkopts=    $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(PODIO_linkopts) 
ALPDataIO_stamps=${ALPDATAIOROOT}/${BINDIR}/ALPDataIO.stamp 
ALPDataIO_linker_library=ALPDataIO
tag=amd64_linux26
package=ALPDataIO
version=v0
PACKAGE_ROOT=$(ALPDATAIOROOT)
srcdir=../src
bin=../$(ALPDataIO_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/data/BOSSParallel/CEPCDataModel/ALPDataIO/amd64_linux26/
...
use_linkopts= $(cmt_installarea_linkopts)   $(ALPDataIO_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(PODIO_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(SniperKernel_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(PODIO_root)/cmt/requirements 
use_includes= $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/usr/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"/cvmfs/sft.cern.ch/lcg/releases/ROOT/v6.20.02-d9e99/x86_64-slc6-gcc8-opt/include" $(ppcmd)"/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/podio/include/" 
use_fincludes= $(use_includes)
use_stamps=  $(ALPDataIO_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps)  $(PODIO_stamps) 
use_cflags=  $(ALPDataIO_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags)  $(PODIO_cflags) 
use_pp_cflags=  $(ALPDataIO_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags)  $(PODIO_pp_cflags) 
use_cppflags=  $(ALPDataIO_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags)  $(PODIO_cppflags) 
use_pp_cppflags=  $(ALPDataIO_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags)  $(PODIO_pp_cppflags) 
use_fflags=  $(ALPDataIO_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags)  $(PODIO_fflags) 
use_pp_fflags=  $(ALPDataIO_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags)  $(PODIO_pp_fflags) 
use_libraries= $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries)  $(PODIO_libraries) 
fincludes= $(includes)
ALPDataIO_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
ALPDataIO_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= ALPDataIO ALPDataIO_python install_more_includes 
all_constituents= $(constituents)
constituentsclean= install_more_includesclean ALPDataIO_pythonclean ALPDataIOclean 
