...
#include "ALPDataIO/datamodel/ExampleReferencingType.h"
#include "ALPDataIO/datamodel/ExampleReferencingTypeConst.h"
#include "ALPDataIO/datamodel/ExampleReferencingTypeObj.h"
